...
public class Janela extends JFrame implements ActionListener {
    ...
    public Janela() {
        ...
        this.btnCorrida = new JButton("Soltar os chorros");
        this.btnCancel = new JButton("Paraaaa");
                  // POSIONADO OS BOT�ES
    ...
    public void actionPerformed(ActionEvent dispara) {
        if (dispara.getSource() == this.btnCorrida) {
            this.lblPista.add(JLabelCarros("Sad doge", imgCarro1, 0, 50));
            this.lblPista.add(JLabelCarros("Samurai doge", imgCarro2, 0, 200));
            this.lblPista.add(JLabelCarros("Buff doge", imgCarro3, 0, 350));
        }
